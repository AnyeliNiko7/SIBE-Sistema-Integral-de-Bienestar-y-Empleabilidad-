...
$queryTurno = "
    ...
    FROM registros_topico
    INNER JOIN turnos ON registros_topico.id_turno = turnos.id_turno
    WHERE registros_topico.estado = 'activo'
...
$querySemestre = "
    ...
    FROM registros_topico
    INNER JOIN semestres ON registros_topico.id_semestre = semestres.id_semestre
    WHERE registros_topico.estado = 'activo'
...
$queryCarrera = "
    ...
    FROM registros_topico
    INNER JOIN carrera ON registros_topico.id_carrera = carrera.id_carrera
    WHERE registros_topico.estado = 'activo'
...
<body>
    ...
    <main class="home-section">
        <section>
            <h2>Reportes Estadísticos - Tópico</h2>
    ...
    <script>
        ...
        const generarAnalisis = (tipo, datosConPorcentaje) => {
            ...
            analisis += `<p>Total de estudiantes atendidos: <span class="total-count">${total}</span></p>`;
            analisis += `<ul>`;
        ...
        document.getElementById('downloadPdf').addEventListener('click', async function() {
            ...
            try {
                ...
                if (turnoImg) {
                    ...
                    page1.innerHTML = `
                        <div class="pdf-header">
                            <h2>Reporte de Tópico - Distribución por Turno</h2>
                        ...
                        <div class="pdf-footer">
                            <p>Reporte generado por el Sistema de Tópico</p>
                        </div>
                    `;
                ...
                if (semestreImg) {
                    ...
                    page2.innerHTML = `
                        <div class="pdf-header">
                            <h2>Reporte de Tópico - Distribución por Semestre</h2>
                            <p>Fecha: ${new Date().toLocaleDateString()}</p>
                        </div>
                        <div class="pdf-chart-container">
                ...
                if (carreraImg) {
                    ...
                    page3.innerHTML = `
                        <div class="pdf-header">
                            <h2>Reporte de Tópico - Distribución por Carreras</h2>
                            <p>Fecha: ${new Date().toLocaleDateString()}</p>
                        </div>
                        <div class="pdf-chart-container">
                ...
                const opt = {
                    margin: 10,
                    filename: 'Reporte_Topico_' + new Date().toISOString().slice(0, 10) + '.pdf',
